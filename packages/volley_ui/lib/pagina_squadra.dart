...
class PaginaSquadra extends StatefulWidget {
  ...
  /// Se mostrare il banner "da dove arrivano questi numeri".
  ///
  /// Dentro l'app va spento: i dati sono quelli del dispositivo, non un
  /// file caricato né un esempio, e un banner che parla di sorgenti
  /// direbbe solo cose che non riguardano chi lo legge.
  final bool mostraSorgente;
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            if (widget.mostraSorgente) BannerSorgente(
