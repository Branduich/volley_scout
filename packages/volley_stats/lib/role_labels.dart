...
Map<String, String> roleLabelsFor(
    String palleggiatoreSlot, Map<String, Ruolo> ruoliPerSlot) {
...
///
/// `ruoliPerSlot` porta i ruoli dei **6 giocatori di rotazione** (entrambi i centrali
...
Map<String, String> roleLabelsFor62(
    String riferimentoSlot, Map<String, Ruolo> ruoliPerSlot) {
