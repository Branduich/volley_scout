...
//
// **Nessun import di drift, riverpod, AppLocalizations o BuildContext**: vive
// nel package condiviso e deve compilare con il solo `flutter`, perché la
...
//
// L'app lo raggiunge tramite la ri-esportazione lasciata in
// `lib/data/backup_model.dart` (passo 5.1 del piano in docs/dati-stagionali.md).
//
