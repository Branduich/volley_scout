...
import 'package:volley_stats/role_labels.dart';
  ...
  group('roleLabelsFor62 — 2P + 2S + 2C', () {
    test('rotazione P1 (riferimento in slot P1): anello P1,S1,C1,P2,S2,C2', () {
      ...
      final labels = roleLabelsFor62('P1', {
        'P1': Ruolo.palleggiatore,
        'P2': Ruolo.schiacciatore,
        'P3': Ruolo.centrale,
        'P4': Ruolo.palleggiatore,
        'P5': Ruolo.schiacciatore,
        'P6': Ruolo.centrale,
      });
    ...
    test('rotazione P3 (riferimento in slot P3) — dai dati CSV utente', () {
      ...
      final labels = roleLabelsFor62('P3', {
        'P3': Ruolo.palleggiatore, // P1 (riferimento)
        'P6': Ruolo.palleggiatore, // P2 (diagonale)
        'P4': Ruolo.schiacciatore, // S1 (dist 1 da P3)
        'P1': Ruolo.schiacciatore, // S2 (dist 4)
        'P5': Ruolo.centrale, // C1 (dist 2)
        'P2': Ruolo.centrale, // C2 (dist 5)
      });
    ...
    test('P1 è sempre lo slot di riferimento; l\'altro palleggiatore è P2', () {
      final labels = roleLabelsFor62('P5', {
        'P5': Ruolo.palleggiatore,
        'P2': Ruolo.palleggiatore,
        'P6': Ruolo.schiacciatore,
        'P3': Ruolo.schiacciatore,
        'P1': Ruolo.centrale,
        'P4': Ruolo.centrale,
      });
      expect(labels['P5'], 'P1');
    ...
    test('la POSIZIONE vince sul ruolo: un non-palleggiatore nel slot '
      ...
      final labels = roleLabelsFor62('P1', {
        'P1': Ruolo.palleggiatore,
        'P4': Ruolo.opposto, // designato alzatore → P2 per posizione
        'P2': Ruolo.schiacciatore,
        'P5': Ruolo.schiacciatore,
        'P3': Ruolo.centrale,
        'P6': Ruolo.centrale,
