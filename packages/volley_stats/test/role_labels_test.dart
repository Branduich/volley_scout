  ...
  group('roleLabelsFor — universali per completamento', () {
    ...
    test('universale al posto di uno schiacciatore → S2 (opposto nel ring '
      ...
      final labels = roleLabelsFor('P1', {
        ...
        'P3': Ruolo.centrale,
        'P4': Ruolo.opposto,
        'P5': Ruolo.undefined, // ring-opposite di P2
        'P6': Ruolo.centrale,
      });
    ...
    test('universale al posto dell\'opposto → O', () {
      final labels = roleLabelsFor('P1', {
        ...
        'P2': Ruolo.schiacciatore,
        'P3': Ruolo.centrale,
        'P4': Ruolo.undefined, // ring-opposite di P1
        'P5': Ruolo.schiacciatore,
        'P6': Ruolo.centrale,
      });
    ...
    test('caso ambiguo 1S+1C+2U: ciascun universale completa la coppia del '
      ...
      final labels = roleLabelsFor('P1', {
        ...
        'P3': Ruolo.centrale,
        'P4': Ruolo.opposto,
        'P5': Ruolo.undefined, // ring-opposite di P2 (S)
        'P6': Ruolo.undefined, // ring-opposite di P3 (C)
      });
